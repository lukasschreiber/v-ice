...
export interface ListSelectBlock extends Blockly.BlockSvg {
    variableType: string,
...
const listSelectMixin: Partial<ListSelectBlock> = {
    saveExtraState: function (this: ListSelectBlock): ListSelectState {
        return {
    ...
    loadExtraState: function (this: ListSelectBlock, state: ListSelectState) {
    ...
    domToMutation: function (this: ListSelectBlock, xmlElement: Element) {
    ...
    mutationToDom: function (this: ListSelectBlock) {
    ...
    updateOutputType_: function (this: ListSelectBlock) {
        this.setOutput(true, this.variableType)
    },
    getListElementInputCount_: function (this: ListSelectBlock) {
        return this.inputList.filter(input => input.name.startsWith("VALUE")).length
    },
    getListElementInputs_: function (this: ListSelectBlock) {
        return this.inputList.filter(input => input.name.startsWith("VALUE"))
    },
    addListElementInput_: function (this: ListSelectBlock, id?: string) {
    ...
    removeListElementInput_: function (this: ListSelectBlock, input: Blockly.Input) {
        this.removeInput(input.name)
    }
}

function listSelectHelper(this: ListSelectBlock) {
