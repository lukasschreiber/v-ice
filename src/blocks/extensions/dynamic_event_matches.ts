...
export class DynamicEventMatchesExtension extends BlockExtension<Blockly.BlockSvg> {
    constructor() {
        super("dynamic_event_matches")
    }

    private static updateVariables(block: Blockly.BlockSvg) {
        ...
        if (timelineTypeString) {
            ...
            DynamicEventMatchesExtension.resetVariables(block)
        }
    }
    
    private static resetVariables(block: Blockly.BlockSvg, newValue_?: string) {
    ...
    extension(this: Blockly.BlockSvg): void {
        this.setOnChange((event) => {
            ...
            if (event.type === Blockly.Events.CHANGE) {
                ...
                if (payload.blockId === this.id && payload.name === "SUBJECT") {
                    ...
                    DynamicEventMatchesExtension.updateVariables(this)
                }
