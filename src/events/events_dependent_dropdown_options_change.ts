 ...
 * 
 * Copied without modification from https://github.com/google/blockly-samples/blob/master/plugins/field-dependent-dropdown/src/dependent_dropdown_options_change.ts
 */
...
import type {FieldDependentDropdown} from '@/blocks/fields/field_dependent_dropdown';
